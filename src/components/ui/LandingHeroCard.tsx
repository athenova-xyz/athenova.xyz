...
export default function LandingHeroCard({
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className="cursor-pointer w-full max-w-sm mx-auto bg-[var(--color-blur-bg)] backdrop-blur-md rounded-2xl p-8 border border-[var(--color-blur-border)] transition-all duration-200 transform hover:scale-105 active:-translate-y-3 shadow-card relative flex flex-col items-center min-h-[220px] focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--card-cyan)]"
    >
